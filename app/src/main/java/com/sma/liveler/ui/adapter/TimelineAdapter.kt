...
class TimelineAdapter(private var onClickTimelineListener: OnClickTimelineListener) :
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (position >= 1) {
            ...
            feedViewHolder.ivLike?.setOnClickListener { onClickTimelineListener.onClickLike(posts[position].id) }
        }
    }
